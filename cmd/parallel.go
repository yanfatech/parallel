...
import (
	...
	"github.com/yanfatech/limiter"
	"github.com/yanfatech/parallel"
...
func (p *ParallelSlaveHandler) Execute(ctx context.Context, command *parallel.Cmd) (output *parallel.Output, err error) {
	output = nil
	err = nil
...
func (p *ParallelSlaveHandler) Ping(ctx context.Context) (r string, err error) {
	return "ping:ok", nil
}
